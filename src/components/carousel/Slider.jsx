...
const IconCarouselComponent = () => {
  ...
  <div className='portafolio-wrapper'>
    <h1 className='h1'>Empresas que me han elegido</h1>
  <div className='logos-wrapper'>
    <img src="https://res.cloudinary.com/dubwhwd1w/image/upload/v1670111664/goat_jkfpoi.webp" alt="logo_cabra-del-valle" style={{backgroundColor: '#212529'}}/>
